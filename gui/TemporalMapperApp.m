classdef TemporalMapperApp < handle
    ...
    properties (Access = public)
        ...
        PlotBuildPanel      matlab.ui.container.Panel
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            setupH = 0.45;
            panelW = 1/4;
            app.DataPanel = uipanel(app.UIFigure, 'Title','Data & Variables', ...
                'Units','normalized', 'Position',[0*panelW 1-setupH panelW setupH]);
            app.PreprocessPanel = uipanel(app.UIFigure, 'Title','Preprocessing', ...
            ...
            app.PlotBuildPanel = uipanel(app.UIFigure, 'Title','Plot & Build', ...
            ...
            app.VariablesLabel = uicontrol(app.DataPanel, 'Style','text', ...
            ...
            app.SelectAllButton = uicontrol(app.DataPanel, 'Style','pushbutton', ...
                'String','Select All', 'Units','normalized', ...
                'Position', app.rowPosition(4,nRows,2,2), ...
                'Callback', @(src,evt) app.SelectAllButtonPushed(src,evt));

            app.VariableListBox = uicontrol(app.DataPanel, 'Style','listbox', ...
                'String',{}, 'Max',2, 'Min',0, 'Value',[], ...
                'Units','normalized', 'Position', app.rowPosition(5,nRows,1,1,4));
            ...
            app.ZscoreCheckBox = uicontrol(app.PreprocessPanel, 'Style','checkbox', ...
                ...
                'Units','normalized', 'Position', app.rowPosition(1,nRows,1,1));
            ...
            app.EmbedLagEditField = uicontrol(app.PreprocessPanel, 'Style','edit', ...
                'String','0', 'Units','normalized', 'Position', app.rowPosition(2,nRows,2,2));
            ...
            % ================= panel 4: plot & build =================
            nRows = 9;
            app.ColorVarLabel = uicontrol(app.PlotBuildPanel, 'Style','text', ...
                'String','Color by:', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(1,nRows,1,2));
            app.ColorVarDropDown = uicontrol(app.PlotBuildPanel, 'Style','popupmenu', ...
                'String',{'(row index)'}, 'Value',1, ...
                'Units','normalized', 'Position', app.rowPosition(1,nRows,2,2));

            app.ColorVarWorkspaceButton = uicontrol(app.PlotBuildPanel, 'Style','pushbutton', ...
                'String','Color: Workspace...', 'Units','normalized', ...
                'Position', app.rowPosition(2,nRows,1,1), ...
                'Callback', @(src,evt) app.ColorVarWorkspaceButtonPushed(src,evt));

            app.TimeVarLabel = uicontrol(app.PlotBuildPanel, 'Style','text', ...
                'String','Time axis:', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(3,nRows,1,2));
            app.TimeVarDropDown = uicontrol(app.PlotBuildPanel, 'Style','popupmenu', ...
                'String',{'(row index)'}, 'Value',1, ...
                'Units','normalized', 'Position', app.rowPosition(3,nRows,2,2));

            app.NodeSizeModeLabel = uicontrol(app.PlotBuildPanel, 'Style','text', ...
                'String','Node size:', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(4,nRows,1,2));
            app.NodeSizeModeDropDown = uicontrol(app.PlotBuildPanel, 'Style','popupmenu', ...
                'String',{'log','rank','original'}, 'Value',1, ...
                'Units','normalized', 'Position', app.rowPosition(4,nRows,2,2));

            app.LabelMethodLabel = uicontrol(app.PlotBuildPanel, 'Style','text', ...
                'String','Label method:', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(5,nRows,1,2));
            app.LabelMethodDropDown = uicontrol(app.PlotBuildPanel, 'Style','popupmenu', ...
                'String',{'mode','mean','median','none'}, 'Value',1, ...
                'Units','normalized', 'Position', app.rowPosition(5,nRows,2,2));

            app.BuildButton = uicontrol(app.PlotBuildPanel, 'Style','pushbutton', ...
                'String','Build Network', 'BackgroundColor',[0.31 0.60 0.95], ...
                'ForegroundColor','white', 'FontWeight','bold', ...
                'Units','normalized', 'Position', app.rowPosition(6,nRows,1,1), ...
                'Callback', @(src,evt) app.BuildButtonPushed(src,evt));

            app.StatusLabel = uicontrol(app.PlotBuildPanel, 'Style','text', ...
                'String','Status:', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(7,nRows,1,1));

            app.StatusTextArea = uicontrol(app.PlotBuildPanel, 'Style','edit', ...
                'String',{'Load a data file to get started.'}, 'Max',2, 'Min',0, ...
                'Enable','inactive', 'HorizontalAlignment','left', ...
                'Units','normalized', 'Position', app.rowPosition(8,nRows,1,1,2));
